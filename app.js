        ...
        const PALETTE = ['🚚', '­ƒÜø', '­ƒø╗', '­ƒø×', '🔧', '­ƒøú', '­ƒøñ', 'ÔÜÖ', '­ƒöº', '📦', '­ƒ¬ñ', '­ƒ¬Ü', '­ƒ¬ø', '­ƒ¬Ø', '­ƒ¬×', '­ƒ¬ƒ', '­ƒ¬á', '­ƒ¬ú', '­ƒ¬¿', '­ƒ¬ü', '­ƒ¬é', '­ƒ¬Ö', '­ƒ¬Æ', '­ƒ¬ö'];
        ...
        function updateFixoUI() {
            ...
            if (subTitle) subTitle.innerText = isDuoOn ? "­ƒÄä🏖️ Duodécimos / Mês" : "­ƒÄä🏖️ Subsídios Integrais";
