        ...
        // ── MULTI-PERFIL: chave din├ómica por email ──
        ...
        const L_C61_PERC = 0.50; // Ajustado para 50% (Cláusula 74.┬¬)
        ...
        // Cláusula 75.┬¬ - Tir de Acordo com o Serviço
        ...
        const MARKERS = [
            ...
            { id: 'adr', label: '☢️´©Å ADR (Dia)', color: '#f97316', value: L_ADR_DIARIO },

            { id: 'op', label: '📦 Operaç├Áes (Dia)', color: '#a855f7', value: L_OP_DIARIO },

            { id: 'ferias', label: '🏖️´©Å Férias / Folga', color: '#eab308', value: 0 }
        ...
        // MOTOR DE CÁLCULO CCT 2026 — FONTE ├ÜNICA DE VERDADE
        ...
        function calcSalary() {
            ...
            // ── IRS 2026: taxa sobre Bruto (Gaveta 1), aplicada ├ás duas gavetas de forma autónoma ──
        ...
        const PALETTE = ['🚚', '­ƒÜø', '­ƒø╗', '­ƒø×', '🔧', '­ƒøú´©Å', '­ƒøñ´©Å', 'ÔÜÖ´©Å', '­ƒöº', '📦', '­ƒ¬ñ', '­ƒ¬Ü', '­ƒ¬ø', '­ƒ¬Ø', '­ƒ¬×', '­ƒ¬ƒ', '­ƒ¬á', '­ƒ¬ú', '­ƒ¬¿', '­ƒ¬ü', '­ƒ¬é', '­ƒ¬Ö', '­ƒ¬Æ', '­ƒ¬ö'];
            ...
            if (bMarkers) {
                ...
                (DB.config.markers || []).forEach((m, idx) => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td><span class="btn-del-row" onclick="delRow('markers', ${idx})">├ù</span></td>
            ...
            if (bKm) {
                ...
                (DB.config.kmEscaloes || []).forEach((e, idx) => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td><span class="btn-del-row" onclick="delKmEscalao(${idx})">├ù</span></td>
        ...
        function updateFixoUI() {
            ...
            if (subTitle) subTitle.innerText = isDuoOn ? "­ƒÄä🏖️´©Å Duodécimos / Mês" : "­ƒÄä🏖️´©Å Subsídios Integrais";
            ...
            (selectedEmojiObjs || []).forEach((obj, idx) => {
                ...
                div.innerHTML = `
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                        ...
                        <span style="color:var(--red); font-weight:bold; cursor:pointer;" onclick="removeEmoji(${idx})">Remover ├ù</span>
        ...
        function computeMonthEngine(forcedDate) {
            ...
            for (let d = 1; d <= 31; d++) {
                ...
                // 4. Bónus Noturno Real (Cláusula 51.┬¬ - 25%)
        ...
        document.getElementById('btn-export-csv').addEventListener('click', () => {
            ...
            csvRows.push(`Retenç├Áes (IRS + SS):;${res.impostosRetidos.toFixed(2).replace('.', ',')} €`);

            csvRows.push('');

            csvRows.push(`TOTAL DO M├èS A RECEBER:;${res.finalLiquidoReceber.toFixed(2).replace('.', ',')} €`);
        ...
        function getShareText(res) {
            ...
            return `*Relatório Journey Tracker - ${new Intl.DateTimeFormat('pt-PT', { month: 'long', year: 'numeric' }).format(curDate)}*\n` +
                ...
                `Ô£à *TOTAL A RECEBER:* € ${res.finalLiquidoReceber.toFixed(2)}\n\n` +
